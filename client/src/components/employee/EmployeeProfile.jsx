    ...
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">You can view and update your personal information.</p>
        </div>

        <div className="space-y-8">
          {/* Profile Info Card */}
          <div className="bg-white rounded-xl border border-gray-400 shadow-sm p-6">
            <h2 className="text-lg font-semibold  text-center text-gray-800 bg-purple-200 py-4 px-2 mb-4 border-b rounded-xl">📝 Basic Information</h2>
          ...
          {/* Summary Card */}
          <div className="bg-white rounded-xl border border-gray-400 shadow-sm p-6">
            <h2 className="text-lg font-semibold bg-purple-200 text-center py-4 px-2 text-gray-800 mb-4 border-b border rounded-xl ">📌 Summary</h2>
            <div className="w-full border-t-2 border-gray-400"></div>
