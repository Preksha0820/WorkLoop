      ...
      {user && (
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            <ChevronDown size={16} className={`text-gray-500 transition-all duration-200 ${isProfileOpen ? 'rotate-180 text-gray-700' : ''} group-hover:text-gray-700`} />
          </button>
            ...
            <div className="absolute right-0 mt-3 w-72 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50">
              ...
              <div className="px-6 py-4 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-100">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-gray-900 text-base">{user.name || 'User'}</p>
              ...
              <div className="py-2 max-h-80 overflow-y-auto">
                {getProfileMenuItems().map((item, idx) => (
                  <button key={idx} onClick={() => { item.action(); setIsProfileOpen(false); }}
